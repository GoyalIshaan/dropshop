...
const ProductDetails: React.FC = () => {
  ...
  const {
    ...
    error,
    isLoading,
  } = useGetProductsDetailsQuery(id) as GetProductsDetailsQuery;
  const commonStyle: string = 'flex items-center text-lg'; // common style for components
